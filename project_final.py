...
names = ['Time', 'V1', 'V2', 'V3', 'V4', 'V5', 'V6', 'V7', 'V8', 'V9', 'V10', 'V11', 'V12', 'V13', 'V14', 'V15',
...
names = ['Time', 'Amount', 'Transaction Method',
         'Transaction Id', 'Location', 'Type of Card', 'Bank']
...
parameters = [{'C': [1, 10, 100, 1000], 'kernel': [
    'rbf'], 'gamma': [0.1, 1, 0.01, 0.0001, 0.001]}]
...
pickle.dump(svc_param, open('modell.pkl', 'wb'))
